...
class LinkedList<T> {
  ...
  traverse(): T[] { /* implementation */ }
    ...
    },
    {
        ...
        shortName: "Tree",
        description: "Hierarchical structure where each node has at most two children. BST maintains ordered property.",
        icon: "🌳",
...
class BinarySearchTree {
  ...
  inOrderTraversal(): number[] { /* implementation */ }
    ...
    },
    {
        ...
        name: "Graph",
        shortName: "Graph",
        description: "Non-linear structure with vertices connected by edges. Can be directed or undirected.",
        icon: "🕸️",
...
class HashTable<K, V> {
  ...
  has(key: K): boolean { return this.table.has(key); }
    ...
    },
    {
        ...
        name: "Heap",
        shortName: "Heap",
        description: "Complete binary tree satisfying heap property. Enables efficient priority queue operations.",
        icon: "⛰️",
