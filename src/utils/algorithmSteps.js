...
export const getStackPushSteps = (value, currentItems) => {
    return [
        {
            action: "Initialize",
...
export const getStackPopSteps = (currentItems) => {
    const topValue = currentItems[currentItems.length - 1];
    return [
        {
            action: "Check Stack",
            description: currentItems.length === 0
                ? "Stack is empty"
...
export const getQueueEnqueueSteps = (value, currentItems) => {
    return [
        {
            action: "Initialize",
...
export const getQueueDequeueSteps = (currentItems) => {
...
export const getArrayInsertSteps = (value, index, currentItems) => {
    const steps = [
        {
            action: "Initialize",
    ...
    if (index < currentItems.length) {
        steps.push({
            ...
            status: "pending",
            highlightedIndices: Array.from({ length: currentItems.length - index }, (_, i) => index + i),
        });
    }
    steps.push({
        action: "Insert Value",
...
export const getArrayRemoveSteps = (index, currentItems) => {
    ...
    if (index < currentItems.length - 1) {
        steps.push({
            ...
            status: "pending",
            highlightedIndices: Array.from({ length: currentItems.length - index - 1 }, (_, i) => index + i),
        });
    }
    steps.push({
        action: "Complete",
...
// Linear Search
export const getArraySearchSteps = (value, currentItems) => {
    const steps = [
        {
            action: "Initialize",
    ...
    for (let i = 0; i < currentItems.length; i++) {
        steps.push({
            ...
            description: currentItems[i] === value
...
// Linked List steps
export const getLinkedListInsertSteps = (value, currentSize) => {
    return [
        {
            action: "Create Node",
...
export const getLinkedListRemoveSteps = (value, currentSize) => {
    return [
        {
            action: "Find Node",
...
// Tree steps
export const getTreeInsertSteps = (value) => {
    return [
        {
            action: "Create Node",
            description: `Create new node with value ${value}`,
...
export const getTreeRemoveSteps = (value) => {
    return [
        {
            action: "Search",
            description: `Search for node with value ${value}`,
...
// Graph steps
export const getGraphDFSSteps = (startNode, nodeCount) => {
    const steps = [
        {
            action: "Initialize",
...
// Heap steps
export const getHeapInsertSteps = (value, newSize) => {
    return [
        {
            action: "Add to End",
...
export const getHeapRemoveSteps = (newSize) => {
    return [
        {
            action: "Remove Root",
