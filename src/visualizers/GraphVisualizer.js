...
export default function GraphVisualizer({
	...
	return _jsx(motion.div, {
		className: "bg-slate-800/50 rounded-lg p-4 overflow-auto",
		children:
			nodes.length === 0
				? _jsx("div", {
						className: "flex items-center justify-center h-96 text-slate-500",
						children: _jsx("p", { children: "No graph data. Create a graph!" }),
				  })
				: _jsxs("svg", {
						width: "100%",
						height: "400",
									...
									motion.g,
									{
										children: [
											_jsx(motion.circle, {
												...
												cy: node.y,
												r: "28",
												fill: highlightedNodes.includes(idx)
													? "#06b6d4"
													: "#3b82f6",
												stroke: highlightedNodes.includes(idx)
													? "#0284c7"
													: "#0ea5e9",
												strokeWidth: "2",
												initial: { scale: 0 },
