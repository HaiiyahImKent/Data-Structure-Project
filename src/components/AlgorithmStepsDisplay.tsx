...
export default function AlgorithmStepsDisplay({
	...
	return (
		<motion.div
			...
			className="space-y-4 max-h-96 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-900"
		>
			{/* Header with Progress */}
			<div className="sticky top-0 space-y-3 bg-gradient-to-b from-slate-800/80 to-transparent pb-3">
