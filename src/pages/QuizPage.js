...
const QUIZ_DATA = {
    array: [
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Arrays are stored in contiguous memory locations, enabling fast index-based access.",
        },
        {
            id: "arr-7",
            ...
            correct: 2,
            explanation: "Without sorting or indexing, you must check each element sequentially, resulting in O(n) complexity.",
        },
        {
            id: "arr-8",
            ...
            correct: 1,
            explanation: "Binary search requires a sorted array but achieves O(log n) complexity by eliminating half of the search space with each comparison.",
        },
        {
            id: "arr-9",
            ...
            correct: 2,
            explanation: "Out-of-bounds access typically throws an ArrayIndexOutOfBoundsException or returns undefined depending on the language.",
        },
        {
            id: "arr-10",
            ...
            correct: 1,
            explanation: "Dynamic arrays grow automatically when they reach capacity, providing flexibility while maintaining O(1) access time.",
        },
        {
            id: "arr-11",
            ...
            options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
            correct: 2,
            explanation: "Arrays use O(n) space to store n elements, where each element occupies a fixed amount of memory.",
        },
        {
            id: "arr-12",
        ...
        },
        {
            ...
            options: ["O(1)", "O(n)", "O(log n)", "O(n²)"],
            correct: 1,
            explanation: "Insertion at the beginning requires shifting all existing elements, resulting in O(n) complexity.",
        },
        {
            id: "arr-14",
            ...
            correct: 2,
            explanation: "Arrays can have any number of dimensions depending on the language implementation.",
        },
        {
            id: "arr-15",
            ...
            correct: 0,
            explanation: "Most modern programming languages use zero-based indexing, where the first element is at index 0.",
        },
        {
            id: "arr-16",
            ...
            correct: 1,
            explanation: "A sparse array contains mostly empty or default values with few actual data elements.",
        },
        {
            id: "arr-17",
            ...
            options: ["O(1)", "O(n)", "O(log n)", "O(n²)"],
            correct: 0,
            explanation: "Although occasional resizing is O(n), the amortized cost per insertion is O(1).",
        },
        {
            id: "arr-18",
            ...
            correct: 2,
            explanation: "Arrays can use indices as keys for frequency counting, providing O(1) lookups and updates.",
        },
        {
            id: "arr-19",
            ...
            options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
            correct: 2,
            explanation: "Reversing an array requires visiting each element once, resulting in O(n) complexity.",
        },
        {
            id: "arr-20",
            ...
            correct: 1,
            explanation: "Arrays provide O(1) random access by index, while linked lists require O(n) traversal to reach a specific element.",
        },
    ],
    stack: [
        {
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Stacks manage function calls in the call stack, pushing when entering a function and popping when returning.",
        },
        {
            id: "stk-7",
            ...
            correct: 1,
            explanation: "Stacks are used to convert and evaluate expressions, particularly for handling operator precedence.",
        },
        {
            id: "stk-8",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Push adds an element to the top of the stack, while pop removes and returns the top element.",
        },
        {
            id: "stk-10",
            ...
            correct: 0,
            explanation: "Recursion relies on the call stack to store function calls and local variables.",
        },
        {
            id: "stk-11",
            ...
            correct: 2,
            explanation: "Stacks can be efficiently implemented using either arrays or linked lists.",
        },
        {
            id: "stk-12",
            ...
            options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
            correct: 2,
            explanation: "Without popping elements, accessing arbitrary elements requires O(n) time.",
        },
        {
            id: "stk-13",
            ...
            correct: 1,
            explanation: "Undo/redo uses two stacks: one tracks changes for undo, the other for redo when undoing.",
        },
        {
            id: "stk-14",
            ...
            correct: 2,
            explanation: "Stack capacity depends on the underlying implementation (array-based or dynamic).",
        },
        {
            id: "stk-15",
            ...
            correct: 1,
            explanation: "Stacks automatically manage function scope and cleanup, making them ideal for call stack management.",
        },
        {
            id: "stk-16",
            ...
            correct: 1,
            explanation: "Depth-first search can be implemented iteratively using a stack to track unvisited vertices.",
        },
        {
            id: "stk-17",
            ...
            correct: 0,
            explanation: "Stack overflow occurs when the stack runs out of allocated memory, often from too much recursion.",
        },
        {
            id: "stk-18",
            ...
            correct: 1,
            explanation: "Each recursive call uses stack space, so deeper recursion requires more stack memory.",
        },
        {
            id: "stk-19",
            ...
            correct: 1,
            explanation: "Stacks match parentheses by pushing opening brackets and popping when finding matching closing brackets.",
        },
        {
            id: "stk-20",
            ...
            correct: 1,
            explanation: "The top of a stack refers to the last element added, which is the first one to be removed (LIFO).",
        },
    ],
    queue: [
        {
        ...
        },
        {
            ...
            correct: 1,
            explanation: "BFS uses a queue to explore vertices level by level, visiting all neighbors before moving deeper.",
        },
        {
            id: "que-8",
            ...
            correct: 1,
            explanation: "The front of a queue is where elements are dequeued from (FIFO principle).",
        },
        {
            id: "que-9",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Circular queues wrap around to reuse memory positions at the front after dequeuing.",
        },
        {
            id: "que-11",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Queues ensure fair scheduling by processing tasks in the order they arrive (FIFO).",
        },
        {
            id: "que-13",
            ...
            correct: 1,
            explanation: "Deques allow insertion and deletion from both front and rear, providing more flexibility.",
        },
        {
            id: "que-14",
            ...
            correct: 1,
            explanation: "Dequeuing from an empty queue throws an exception or returns null depending on implementation.",
        },
        {
            id: "que-15",
            ...
            correct: 1,
            explanation: "Queues can be efficiently implemented using linked lists with pointers to front and rear.",
        },
        {
            id: "que-16",
            ...
            correct: 2,
            explanation: "Queues distribute work fairly and enable load balancing by processing requests in order.",
        },
        {
            id: "que-17",
            ...
            correct: 1,
            explanation: "Circular queues efficiently reuse freed positions by wrapping around, avoiding wasted space.",
        },
        {
            id: "que-18",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Message queues enable asynchronous communication between services, improving system reliability.",
        },
        {
            id: "que-20",
            ...
            options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
            correct: 2,
            explanation: "Accessing arbitrary elements requires traversing from the front, which is O(n).",
        },
    ],
    "linked-list": [
        {
        ...
        },
        {
            ...
            correct: 1,
            explanation: "A node is a basic unit of a linked list containing data and pointers (references) to other nodes.",
        },
        {
            id: "ll-7",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "The tail is the last node in a linked list, typically with a null pointer.",
        },
        {
            id: "ll-9",
            ...
            options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
            correct: 2,
            explanation: "Accessing the nth element requires traversing from the head, which is O(n).",
        },
        {
            id: "ll-10",
            ...
            correct: 1,
            explanation: "In a circular linked list, the last node points to the first node, creating a cycle.",
        },
        {
            id: "ll-11",
            ...
            correct: 1,
            explanation: "Singly linked list nodes require one additional pointer per node compared to array elements.",
        },
        {
            id: "ll-12",
            ...
            correct: 1,
            explanation: "Doubly linked lists allow traversal in both directions and simplify deletion operations.",
        },
        {
            id: "ll-13",
            ...
            options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
            correct: 0,
            explanation: "If you have a reference to the node to delete, deletion is O(1) for pointer updates.",
        },
        {
            id: "ll-14",
            ...
            correct: 1,
            explanation: "Linked lists allocate new nodes dynamically, allowing automatic growth without reallocation.",
        },
        {
            id: "ll-15",
            ...
            correct: 1,
            explanation: "The tortoise and hare algorithm detects cycles by using two pointers at different speeds.",
        },
        {
            id: "ll-16",
        ...
        },
        {
            ...
            correct: 3,
            explanation: "Linked lists can be reversed by reversing pointers iteratively or using a stack.",
        },
        {
            id: "ll-18",
            ...
            correct: 1,
            explanation: "Linked lists provide O(1) insertion at the front when you have the head reference.",
        },
        {
            id: "ll-19",
            ...
            correct: 0,
            explanation: "If node memory isn't properly freed, it can lead to memory leaks in systems without garbage collection.",
        },
        {
            id: "ll-20",
            ...
            correct: 1,
            explanation: "Arrays have better cache locality since they're contiguous; linked lists scattered in memory suffer cache misses.",
        },
    ],
    tree: [
        {
        ...
        },
        {
            ...
            correct: 2,
            explanation: "A leaf node is a node with no children, representing the end of a branch.",
        },
        {
            id: "tree-7",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "A balanced tree maintains heights of subtrees within a certain range, ensuring optimal performance.",
        },
        {
            id: "tree-11",
            ...
            correct: 1,
            explanation: "Red-Black trees are self-balancing BSTs that maintain balance through color properties.",
        },
        {
            id: "tree-12",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Binary trees allow each node to have at most 2 children (left and right).",
        },
        {
            id: "tree-15",
            ...
            correct: 1,
            explanation: "A complete binary tree has all levels filled except possibly the last, which is filled left to right.",
        },
        {
            id: "tree-16",
            ...
            correct: 1,
            explanation: "AVL trees are self-balancing BSTs maintaining height balance for O(log n) operations.",
        },
        {
            id: "tree-17",
            ...
            correct: 1,
            explanation: "A perfect binary tree has all internal nodes with 2 children and all leaves at the same depth.",
        },
        {
            id: "tree-18",
            ...
            correct: 1,
            explanation: "BST structure allows elimination of half the remaining nodes with each comparison, achieving O(log n).",
        },
        {
            id: "tree-19",
    ...
    graph: [
        ...
        },
        {
            ...
            correct: 1,
            explanation: "A vertex is the fundamental unit of a graph representing entities or data points.",
        },
        {
            id: "graph-7",
            ...
            correct: 1,
            explanation: "An edge is a connection between two vertices, potentially with a weight or direction.",
        },
        {
            id: "graph-8",
            ...
            correct: 1,
            explanation: "Weighted graphs have numerical values associated with edges, representing distances, costs, etc.",
        },
        {
            id: "graph-9",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "A connected graph allows traversal from any vertex to any other vertex through edges.",
        },
        {
            id: "graph-11",
            ...
            correct: 1,
            explanation: "Adjacency matrix is an n×n matrix where entry (i,j) indicates edge presence between vertices i and j.",
        },
        {
            id: "graph-12",
            ...
            correct: 1,
            explanation: "Adjacency list represents each vertex with a list of its adjacent vertices, using less space than matrices.",
        },
        {
            id: "graph-13",
            ...
            correct: 1,
            explanation: "A spanning tree is an acyclic subgraph connecting all vertices using n-1 edges.",
        },
        {
            id: "graph-14",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Dijkstra's algorithm finds the shortest path between vertices in weighted graphs.",
        },
        {
            id: "graph-16",
            ...
            correct: 1,
            explanation: "A bipartite graph has vertices partitioned into two sets with edges only between sets.",
        },
        {
            id: "graph-17",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "A DAG is a directed graph containing no cycles, useful for dependency representation.",
        },
        {
            id: "graph-19",
            ...
            correct: 1,
            explanation: "Topological sorting orders vertices such that for every edge u→v, u comes before v.",
        },
        {
            id: "graph-20",
            ...
            correct: 1,
            explanation: "Floyd-Warshall finds shortest paths between all pairs of vertices in weighted graphs.",
        },
    ],
    heap: [
        {
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Heapify converts an unsorted array into a valid heap structure by rearranging elements.",
        },
        {
            id: "heap-8",
            ...
            correct: 1,
            explanation: "Heap sort builds a heap from array elements, then repeatedly extracts root (max/min), resulting in sorted order.",
        },
        {
            id: "heap-9",
            ...
            correct: 2,
            explanation: "Heap sort sorts in-place using only O(1) additional space beyond the input array.",
        },
        {
            id: "heap-10",
            ...
            correct: 0,
            explanation: "Building a heap from n elements can be done in O(n) time using bottom-up approach.",
        },
        {
            id: "heap-11",
            ...
            correct: 1,
            explanation: "Heaps are usually represented as arrays where children of node i are at indices 2i+1 and 2i+2.",
        },
        {
            id: "heap-12",
            ...
            correct: 1,
            explanation: "Priority queue is an abstract data type where elements are served based on their priority, often implemented using heaps.",
        },
        {
            id: "heap-13",
            ...
            correct: 1,
            explanation: "Peek returns the root element (max in max-heap, min in min-heap) without removing it.",
        },
        {
            id: "heap-14",
            ...
            correct: 1,
            explanation: "Extract removes and returns the root element, then restructures the remaining heap.",
        },
        {
            id: "heap-15",
            ...
            correct: 0,
            explanation: "Heapify-up moves a newly inserted element toward the root to maintain heap property.",
        },
        {
            id: "heap-16",
            ...
            correct: 1,
            explanation: "Heapify-down moves an element from root down the tree swapping with larger/smaller child to maintain heap property.",
        },
        {
            id: "heap-17",
            ...
            correct: 1,
            explanation: "Binary heap is a complete binary tree satisfying heap property where children of node i are at 2i+1 and 2i+2.",
        },
        {
            id: "heap-18",
            ...
            correct: 1,
            explanation: "Heaps allow duplicate values. The heap property only requires parent-child relationships, not uniqueness.",
        },
        {
            id: "heap-19",
            ...
            options: ["O(n)", "O(n log n)", "O(log n)", "O(n²)"],
            correct: 1,
            explanation: "Heap sort has O(n) build time plus O(n log n) extraction time, resulting in overall O(n log n).",
        },
        {
            id: "heap-20",
            ...
            correct: 1,
            explanation: "D-ary heap is a generalization where each node has d children instead of 2, useful for some applications.",
        },
    ],
    "hash-table": [
        {
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Chaining maintains a linked list at each hash table index to handle multiple keys hashing to the same location.",
        },
        {
            id: "ht-7",
            ...
            correct: 1,
            explanation: "Open addressing searches for another empty slot in the hash table when a collision occurs.",
        },
        {
            id: "ht-8",
            ...
            correct: 1,
            explanation: "Linear probing checks consecutive slots (hash(key), hash(key)+1, hash(key)+2...) to find an empty spot.",
        },
        {
            id: "ht-9",
            ...
            correct: 1,
            explanation: "Quadratic probing checks slots at positions hash(key), hash(key)+1², hash(key)+2², etc.",
        },
        {
            id: "ht-10",
            ...
            correct: 1,
            explanation: "Double hashing uses a second hash function to determine probe step size, reducing clustering.",
        },
        {
            id: "ht-11",
            ...
            correct: 1,
            explanation: "Good hash functions compute quickly, distribute keys uniformly, and minimize collisions.",
        },
        {
            id: "ht-12",
            ...
            options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
            correct: 2,
            explanation: "In worst case (all keys hash to same slot with chaining), search is O(n).",
        },
        {
            id: "ht-13",
            ...
            correct: 1,
            explanation: "Resizing rehashes entries into a larger table to maintain good load factor and performance.",
        },
        {
            id: "ht-14",
            ...
            correct: 1,
            explanation: "Clustering occurs when collisions cause consecutive slots to fill, increasing future probe lengths.",
        },
        {
            id: "ht-15",
            ...
            correct: 1,
            explanation: "Universal hashing uses randomized hash functions to guarantee low collision probability on adversarial input.",
        },
        {
            id: "ht-16",
            ...
            correct: 1,
            explanation: "Bloom filter uses multiple hash functions and bits to test membership with O(1) time and minimal space.",
        },
        {
            id: "ht-17",
            ...
            correct: 1,
            explanation: "Consistent hashing maps keys to servers such that adding/removing servers minimally redistributes keys.",
        },
        {
            id: "ht-18",
            ...
            correct: 1,
            explanation: "Cuckoo hashing uses multiple hash tables, displacing existing elements if needed (like cuckoo birds).",
        },
        {
            id: "ht-19",
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Hash tables excel for frequent lookups/insertions with O(1) average time when ordering isn't needed.",
        },
    ],
};
